...
// Counting selected slider image
const countSlide = isTrue => {
    const count = document.getElementById('selection').innerText;
    let slideCount = parseInt(count);
    if (isTrue) {
        document.getElementById('selection').innerText = slideCount + 1;
    } else {
        document.getElementById('selection').innerText = slideCount - 1;
    }
};

// Show images after clicking search button
const showImage = () => {
...
searchBtn.addEventListener('click', function () {
    showImage();
    document.getElementById('selection').innerText = '0';
});
